...
const Sobre = () => {
  ...
  const onSobreContainer3Click = useCallback(() => {
  ...
  return (
    <div className={styles.sobre}>
      ...
      <div className={styles.startups}>
        ...
        <div className={styles.starter}>
          ...
          <div className={styles.grupo262}>
            ...
            <div className={styles.componente547}>
      ...
      <div className={styles.sistemas1}>
          ...
          <div className={styles.grupo348}>
            <div className={styles.boto} onClick={onBOTOContainerClick}>
              <img
                ...
                src="../caminho-520.svg"
              />
              <div className={styles.conheaNossoSistema}>
        ...
        <b className={styles.conheaNossosSistemasContainer}>
          <p className={styles.centroCaxiasDo}>
            Conheça nossos Sistemas, as soluções e benefícios
          </p>
          <p className={styles.centroCaxiasDo}>
            que eles proporcionam para o seu negócio.
          </p>
        </b>
      </div>
      <div className={styles.sobre3}>
        <div className={styles.texto2}>
          <div className={styles.somosFormadosPorContainer}>
            <p className={styles.centroCaxiasDo}>
              Somos formados por uma equipe qualificada, multidisciplinar que
              trabalha para inovar e implementar soluções criativas com o
              objetivo de melhor atender as necessidades específicas de cada
              cliente.
            </p>
            <p className={styles.centroCaxiasDo}>&nbsp;</p>
            <p className={styles.centroCaxiasDo}>
              Aqui na Valorizza, temos a cultura de melhoria constante. Todas as
              sugestões e solicitações de evolução e aperfeiçoamento que
              recebemos, de quem tem contato diário com o nosso sistema, são de
              fundamental importância.
            </p>
          </div>
          <div className={styles.grupo375}>
            <img
              className={styles.caminho516Icon}
              alt=""
              src="../caminho-516.svg"
            />
            <div className={styles.osResultadosS}>
              Os resultados só são atingidos em nível de excelência quando a
              dedicação é coletiva. Assim, desfrutamos juntos da alegria de
        ...
        <div className={styles.foto}>
          <img
            className={styles.grupoDeMscara17}
            alt=""
            src="../grupo-de-mscara-17@2x.png"
          />
          <b className={styles.nsAcreditamosQue}>
            Nós acreditamos que a tecnologia pode aproximar as pessoas.
          </b>
        </div>
        <div className={styles.texto1}>
          <div className={styles.aTecnologiaEstContainer}>
            <p className={styles.centroCaxiasDo}>
              ...
              fundamental para a evolução profissional, a conquista de
              reconhecimento e de destaque frente ao mercado cada vez mais
              competitivo.
            </p>
            <p className={styles.centroCaxiasDo}>&nbsp;</p>
            <p className={styles.centroCaxiasDo}>
              É nessa intersecção que a Valorizza atua, desde 2003, junto das
              melhores Instituições de Ensino, Agências de Recrutamento e
              Seleção e Agentes de Integração do Brasil, proporcionando uma
              poderosa ferramenta que fortalece o vínculo entre os usuários,
              tanto alunos quanto empresas, com o seu negócio.
            </p>
          </div>
          <div className={styles.grupo376}>
            <img
              className={styles.caminho516Icon}
              alt=""
              src="../caminho-516.svg"
            />
            <div className={styles.osResultadosS}>
              Oferecemos o diferencial para estudantes e profissionais
              impulsionarem suas carreiras e transformarem o mercado de trabalho
              a nível nacional.
            </div>
          </div>
        </div>
      ...
      <div className={styles.hero}>
        <img className={styles.grupo15Icon} alt="" src="../grupo-151@2x.png" />
        <div className={styles.retngulo128} />
        <div className={styles.h20AnosContainer}>
          <span className={styles.h20Anos}>{`Há 20 anos `}</span>
          <b className={styles.valorizzando}>Valorizzando</b>
          <span className={styles.h20Anos}>
            {" "}
            Instituições de Ensino, Agências de Recrutamento e Seleção e Agentes
            de Integração.
          </span>
        </div>
      </div>
